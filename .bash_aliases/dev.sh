...
alias pcs=pip-sync
alias pcu='pip-compile --upgrade > /dev/null'
alias pf='pip list'
...
# Django (pd)
alias pdc='python manage.py collectstatic '
...
alias pdmw='python manage.py showmigrations '
...
alias ocp='oc $(bop)'  # open copied text
function ocs {
...
alias rey='eb deploy '
alias reyg='eb deploy --staged '

# Heroku (rh)
alias rhl='heroku logs -t '
alias rhs='heroku run bash '
alias rhss='heroku run python manage.py shell_plus --print-sql --quiet-load '
alias rhy='git push heroku HEAD:master'

# Logging hours (ol)
alias ol='~/log ~/timesheet.txt '
alias ole='ol -e gedit '
alias olr='ol -r '
alias olo='~/log '  # local
alias oloe='~/log -e gedit '
alias olor='~/log -r '
